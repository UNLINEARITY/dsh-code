...
import { HistoryPanel, JobsPanel, ModePanel, PermissionPanel, ResumePanel, SearchPanel, type JobRow, type SearchRow } from '../src/kernel-panels.ts'
import { editQuery } from '../src/query-editor.ts'
