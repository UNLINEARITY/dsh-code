...
export const zh: MessageCatalog = {
  ...
  'notice.legacySettingsUnmigrated': '旧版设置未迁移——模型可能缺失；将 settings.yaml.imported 复制为 settings.yaml 后重启',
  'notice.legacySettingsRecovered': '旧版设置（{sections}）已自动重新导入，模型配置已恢复',
  'notice.legacySettingsRecoverFailed': '旧版设置自动导入失败——将 settings.yaml.imported 复制为 settings.yaml 后重启',
