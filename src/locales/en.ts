...
export const en = {
  ...
  'notice.legacySettingsUnmigrated': 'legacy settings not migrated — models may be missing; restore settings.yaml from settings.yaml.imported and restart',
  'notice.legacySettingsRecovered': 'legacy settings ({sections}) re-imported; model configuration restored',
  'notice.legacySettingsRecoverFailed': 'failed to re-import legacy settings; copy settings.yaml.imported to settings.yaml and restart',
