...
- Input with history (↑/↓), cursor editing (←/→, Ctrl+A/E/U), Tab completion for slash commands and skills; `Esc` or Ctrl+C interrupts the running turn, Ctrl+C on an empty idle input exits, Ctrl+D refuses to exit mid-turn
